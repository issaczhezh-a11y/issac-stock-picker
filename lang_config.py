...
LANG = {
    "CN": {
        ...
        "pe_label": "最高 P/E (市盈率)",
        "pe_help": "市盈率：衡量回本年限。数值越低估值越便宜。科技股建议 < 35。",
        "peg_label": "最高 PEG (估值增长比)",
        "peg_help": "PEG < 1.0 代表被低估。机构常用它判断高速增长公司的性价比。",
        "roe_label": "最低 ROE % (净资产收益率)",
        "roe_help": "ROE 代表公司赚钱效率。巴菲特最看重的指标，长期 > 15% 是绩优股门槛。",
        "fcf_label": "最低 FCF $B (自由现金流)",
        "fcf_help": "自由现金流：扣除开支后剩下的真金白银。充沛的现金流是公司回购股票的底气。",
    ...
    "EN": {
        ...
        "snapshot_title": "📊 Core Metrics Snapshot", "report_title": "Deep Report",
        ...
        "moat_elite": "💎 **Elite Moat**. High pricing power.",
        "moat_wide": "🛡️ **Wide Moat**. Mature barriers.",
        "moat_narrow": "🚧 **Narrow Moat**. competition risk.",
        "fin_title": "🏛️ Pillar II: Fundamentals",
        "consistency_label": "· **ROE Stability**: **{curr}%** (TTM) vs **{prev}%** (Ref).",
        "cash_label": "· **Cash Position**: **${val}B**.",
        ...
        "strategies": ["Wait.", "Monitor.", "Accumulate.", "Conviction Hold."],
        ...
        "macro_hist_desc": "📜 Low scores signal bottoms."
    }
}
