...
LANG = {
    ...
    "EN": {
        ...
        "rs_title": "⚔️ Relative Strength (RS) Momentum (New)",
        ...
        "earnings_label": "🚦 **Earnings High-Risk Alert**: Upcoming on {date} ({days} days away). Risk of binary event; recommend waiting.",
        
        "moat_title": "🏰 Business Model & Moat Insight",
        "fin_title": "🏛️ Fundamentals & Financial Safety",
        "consistency_label": "· **ROE Stability Audit (New)**: **{curr}%** (Curr) vs **{prev}%** (Ref). Profit model is consistent.",
