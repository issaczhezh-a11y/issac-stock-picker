# lang_config.py - Issac Terminal 终极智库 (v50.1 最终防弹版)
LANG = {
    "CN": {
        ...
        "pe_label": "最高 P/E (市盈率)",
        "pe_help": "Price-to-Earnings Ratio: 衡量回本年限。数值越低通常代表估值越便宜。科技股建议 < 35。",
        ...
        "fcf_help": "Free Cash Flow: 扣除开支后的现金。流出充沛的公司抗风险能力极强。",
        ...
        "ma200_help": "200日均线：机构的‘多空分水岭’。股价在其上方为‘牛市’。",
        "inst_help": "机构持仓占比：反映大资金信心。> 70% 代表该股是‘机构抱团股’。",
        ...
        "debt_help": "Debt-to-Equity: 负债率。低负债（< 40%）的公司生存能力更强。",
        ...
        "vix_label": "📉 恐慌指数 (VIX)",
        "vix_help": "VIX 衡量市场恐慌程度。> 28 意味着极度恐慌；< 15 意味着非常贪婪。",
        "tnx_label": "🏛️ 10年美债收益率",
        "tnx_help": "全球资产定价之锚。它上升时，科技股估值往往受压制。",
    ...
    "EN": {
        ...
        "score_help": "Value, Quality, and Momentum score.",
