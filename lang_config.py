# lang_config.py - Issac Terminal 智库文案库 (v31.0)
LANG = {
    "CN": {
        ...
        "growth_title": "📈 成长动能与现金含量 (New)",
        "cagr_label": "营收增长 (CAGR)",
        "fcf_yield_label": "现金流收益率 (FCF Yield)",
    ...
    "EN": {
        ...
        "growth_title": "📈 Growth Momentum & FCF Yield (New)",
        "cagr_label": "Revenue Growth (CAGR)",
        ...
        "chart_close": "Close Price",
        "chart_ma200": "MA200 Line",
        "chart_date": "Date",
        ...
        "debt_healthy": "🟢 Extremely Healthy",
        "debt_mid": "🟡 Moderate Leverage",
        "debt_high": "🔴 High Financial Pressure",
        "debt_audit": "· **Debt Audit**: D/E Ratio `{val}%` — {status}",
        "upside_desc": "· **Growth Upside**: Analyst target is `${target}`, potential gain `{upside}`.",
        "inst_high": "Institutions hold {inst:.1f}%, highly concentrated.",
        "inst_mid": "Institutions hold {inst:.1f}%, balanced ownership.",
