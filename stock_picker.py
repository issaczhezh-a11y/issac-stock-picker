...
def get_analysis(s):
    try:
        ...
        # 🎯 修复 LITE 问题：只要历史不为空，即使不够 200 天也生成报告
        ...
        try:
            ...
            # 抓取上季历史
            e_dates = tk.get_earnings_dates(limit=6)
...
if search_ticker:
    ...
    else: st.error("Ticker not found or Data throttled. Try MSFT to verify.")
